...
typedef struct {
    ...
    uint64_t rdma_atomic_post_send_ns;
    uint64_t rdma_atomic_poll_cq_ns;
    uint64_t rdma_atomic_backoff_ns;
    uint64_t rdma_request_reserve_ns;
    uint64_t rdma_request_publish_ns;
    uint64_t rdma_request_payload_write_ns;
    uint64_t rdma_request_completion_wait_ns;
    size_t rdma_read_empty_polls;
    size_t rdma_read_backoff_count;
    size_t rdma_write_empty_polls;
    size_t rdma_write_backoff_count;
    size_t rdma_atomic_empty_polls;
    size_t rdma_atomic_backoff_count;
    size_t rdma_request_ring_full;
    size_t rdma_request_publish_spins;
